...
var chatting_person = require('./routes/chatting_person');
var post_on_off = require('./routes/post_on_off');
...
app.post('/routes/chatting_person',chatting_person.chatting_person);
app.post('/routes/post_on_off',post_on_off.post_on_off);
